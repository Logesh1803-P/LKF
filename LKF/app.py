...
def index():
    if request.method == 'POST':
        ...
        if result:
            ...
            return render_template('dark.html', image_url= xss_attack_username, image_url1= xss_attack_password)
        ...
        if status == "Blocked":
            # Return a block page if attack is detected
            return render_template('dark.html', image_url= xss_attack_username, image_url1= xss_attack_password)
        else:
